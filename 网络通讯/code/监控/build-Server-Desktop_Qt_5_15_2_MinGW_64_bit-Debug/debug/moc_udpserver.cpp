...
QT_MOC_LITERAL(1, 10, 15), // "lockMouseSignal"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 6), // "isLock"
QT_MOC_LITERAL(4, 34, 10), // "udpTimeOut"
QT_MOC_LITERAL(5, 45, 20) // "readPendingDatagrams"

    },
    "UdpServer\0lockMouseSignal\0\0isLock\0"
    "udpTimeOut\0readPendingDatagrams"
};
...
void UdpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->lockMouseSignal((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->udpTimeOut(); break;
        ...
        {
            using _t = void (UdpServer::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpServer::lockMouseSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void UdpServer::lockMouseSignal(bool _t1)
{
