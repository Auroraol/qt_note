...
inline int32_t Info::_internal_number() const {
  return _impl_.number_;
}
inline int32_t Info::number() const {
  // @@protoc_insertion_point(field_get:Info.number)
  return _internal_number();
}
inline void Info::_internal_set_number(int32_t value) {
  
  _impl_.number_ = value;
}
inline void Info::set_number(int32_t value) {
